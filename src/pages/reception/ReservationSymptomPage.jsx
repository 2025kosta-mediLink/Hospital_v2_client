...
export default function ReservationSymptomPage() {
  ...
  // 모달에서 "바로 접수하기" 클릭 → 예약 기반 접수 API 호출
  const handleConfirmReception = async () => {
    try {
      console.log("=== 예약 기반 접수 생성 시작 ===");
      console.log("reservationId:", reservationId);
      console.log("selectedSymptoms:", selectedSymptoms);
      console.log("noteToDoctor:", noteToDoctor);

      const createResult = await createReceptionFromReservation({
        reservationId,
          ...
          <form id="symptomForm" onSubmit={handleNext} className="p-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl shadow-sm p-3.5 mb-3">
              ...
              <div className="text-sm text-blue-700 space-y-1">
                ...
                {reservationTime && <div>예약 시간: {reservationTime}</div>}
              </div>
            </div>
